            ...
            <div class="col-span-2">
                <div class="card p-6">
                    <div class="mb-4">
                        ...
                        <input type="text" wire:model="title" id="title" class="input" />
                    </div>

                    <div class="mb-4" wire:ignore>
                        <label class="label">Descripción:</label>
                        <textarea id="editor" wire:model="description" class="input" rows="6"></textarea>
                    </div>
            ...
            <div class="col-span-1">
                <div class="card p-6">
                    ...
                    <div class="mb-4">
                        ...
                        @endif
                        <input type="file" wire:model="image" id="image" class="mt-1 p-2 w-full border rounded-md" />
                    </div>
                </div>
            </div>
